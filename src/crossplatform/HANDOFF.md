...
> 1. **`_NET_WM_ICON` da verificare su un desktop vero** con `xprop`: su Xvfb è assente anche per la
>    build pre-rinomina e qui non c'è nessun window manager, quindi la prova non chiude.
