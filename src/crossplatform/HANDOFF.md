...
**M222**. Ultimo giro: CI su `104a8c861` **verificata verde** (fix M215 confermato), il selettore
...
1. git -C /home/dario/git_ext_mod rev-parse --short HEAD  (atteso 2897877bf o piu' avanti; se diverso,
...
- banchi: Tests/run-all.sh --no-build   (deve dire ALL GREEN: 8 harnesses)
...
Quando consegni: aggiorna PORTING.md (nuova milestone, la prossima libera e' M222), ROADMAP.md se
